                        ...
                        [
                            {
                                ...
                                "value": [
                                    ...
                                    [
                                        ...
                                        {
                                            "type": "tagged_union",
                                            "tag": "COMMUNICATION_MODE_SUPPORTED",
                                            "value": [
                                                [
                                                    {"tag": "SLAVE", "value": None},
...
def test_etas2(etas_aml):
    ...
    assert res == [
        {
            "value": [[{"value": [0, 3489665600, 2, [{"value": 1, "tag": "RASTER"}]], "type": "struct", "tag": "KP_BLOB"}]],
            "tag": "IF_DATA",
        }
    ]
...
def test_etas3(etas_aml):
    ...
    assert res == [
        {
            "tag": "IF_DATA",
            "value": [[{"type": "struct", "tag": "KP_BLOB", "value": [3489665600, "INTERN", 2, [{"tag": "RASTER", "value": 2}]]}]],
        }
    ]
