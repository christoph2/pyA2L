...
namespace atn {
    ...
    class ANTLR4CPP_PUBLIC PredictionContext {
       public:
        ...
        // dispatch
        static Ref<const PredictionContext> merge(
            Ref<const PredictionContext> a, Ref<const PredictionContext> b, bool rootIsWildcard,
         ...
         */
        static Ref<const PredictionContext> mergeRoot(
            Ref<const SingletonPredictionContext> a, Ref<const SingletonPredictionContext> b, bool rootIsWildcard
        );
