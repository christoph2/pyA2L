    ...
    class ANTLR4CPP_PUBLIC LexerATNSimulator : public ATNSimulator {
       ...
       protected:
        ...
        void getReachableConfigSet(
            CharStream *input, ATNConfigSet *closure_,  // closure_ as we have a closure() already
            ATNConfigSet *reach, size_t t
        );

        virtual void accept(
            CharStream *input, const Ref<const LexerActionExecutor> &lexerActionExecutor, size_t startIndex, size_t index,
